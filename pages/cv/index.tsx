        ...
        return (
            <div className="flex-1 ">
                <div className="pt-2 pb-4">
                            ...
                            return (
                                <li className="pb-1" key={`strength-${index}`}>
                                    ...
                                    {/* <span className="flex absolute -left-8 top-2 justify-center items-center w-4 h-4 bg-blue-200 rounded-full ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                                        <svg className="w-2 h-2 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"></path></svg>
                                    </span>
                    ...
                    <ol className="border-l border-gray-200 dark:border-gray-700 ml-8 mt-3 pr-10">
                        ...
                        {obj.experiences.map((item: any) => {
                            return (
                                <li className="mb-6 ml-6 relative text-gray-600" key={item.title}>
                                    ...
                                    <h3 className="flex items-center text-lg font-semibold text-gray-900 dark:text-white">{item.title}</h3>
                        ...
                        {obj.skills.map((item: any) => {
                            return (
                                <li className="mb-4 ml-6 relative" key={item.title}>
                                    <h3 className="flex items-center mb-1 text-lg text-primary dark:text-white">{item.title}</h3>
                                    <ul className="list-disc list-inside">
